                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        checked={useBatches}
                                        onChange={(e) => {
                                            setUseBatches(e.target.checked)
                                            form.setValue("useBatches", e.target.checked)
                                            if (!e.target.checked) {
                                        ...
                                        className="h-4 w-4 rounded border-psi-primary text-psi-primary focus:ring-psi-primary"
                                    />
