        ...
        <div className={cn("space-y-2", className)}>
            ...
            {isPreview ? (
                <div className="min-h-[120px] rounded-md border border-input bg-transparent px-3 py-2 text-sm overflow-y-auto">
                    {value ? (
                        <div className="text-psi-dark [&>h1]:text-2xl [&>h1]:font-bold [&>h1]:mb-2 [&>h2]:text-xl [&>h2]:font-bold [&>h2]:mb-2 [&>h3]:text-lg [&>h3]:font-semibold [&>h3]:mb-2 [&>p]:mb-2 [&>ul]:list-disc [&>ul]:ml-4 [&>ul]:mb-2 [&>ol]:list-decimal [&>ol]:ml-4 [&>ol]:mb-2 [&>li]:mb-1 [&>strong]:font-bold [&>em]:italic [&>code]:bg-[#F3F4FB] [&>code]:px-1 [&>code]:py-0.5 [&>code]:rounded [&>code]:text-xs [&>pre]:bg-[#F3F4FB] [&>pre]:p-2 [&>pre]:rounded [&>pre]:overflow-x-auto [&>pre]:mb-2 [&>blockquote]:border-l-4 [&>blockquote]:border-psi-primary/30 [&>blockquote]:pl-4 [&>blockquote]:italic [&>blockquote]:mb-2 [&>a]:text-psi-primary [&>a]:underline">
